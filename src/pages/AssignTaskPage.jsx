                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            required
                            rows="4"
                            className="w-full p-3 rounded-lg border border-slate-200 focus:outline-none focus:border-primary"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <select
                                    name="assignee"
                                    required
                                    className="w-full pl-10 pr-4 py-2 rounded-lg border border-slate-200 focus:outline-none focus:border-primary bg-white"
                        ...
                        <div>
                            ...
                            <select
                                name="priority"
                                className="w-full px-4 py-2 rounded-lg border border-slate-200 focus:outline-none focus:border-primary bg-white"
