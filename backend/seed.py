...
USERS = [
    {"id": "ADMIN001", "name": "Sarah Connor",    "role": "ADMIN",    "department": "Administration",               "password": "Perfmetric@123", "manager_id": None},
    {"id": "CFO001",   "name": "David Hughes",    "role": "CFO",      "department": "Finance",                      "password": "Perfmetric@123", "manager_id": None},
    {"id": "MGR001",   "name": "John Smith",      "role": "MANAGER",  "department": "Engineering",                  "password": "Perfmetric@123", "manager_id": "CFO001"},
    {"id": "MGR002",   "name": "Emily Blunt",     "role": "MANAGER",  "department": "Sales",                        "password": "Perfmetric@123", "manager_id": "CFO001"},
    {"id": "MGR003",   "name": "Alan Reed",       "role": "MANAGER",  "department": "Accounts Receivables",         "password": "Perfmetric@123", "manager_id": "CFO001"},
    {"id": "MGR004",   "name": "Sandra Cole",     "role": "MANAGER",  "department": "Accounts Payables",            "password": "Perfmetric@123", "manager_id": "CFO001"},
    {"id": "MGR005",   "name": "Victor Hunt",     "role": "MANAGER",  "department": "Fixed Assets",                 "password": "Perfmetric@123", "manager_id": "CFO001"},
    {"id": "MGR006",   "name": "Priya Nair",      "role": "MANAGER",  "department": "Treasury and Trade Finance",   "password": "Perfmetric@123", "manager_id": "CFO001"},
    {"id": "MGR007",   "name": "Leon Watts",      "role": "MANAGER",  "department": "MIS Report and Internal Audit","password": "Perfmetric@123", "manager_id": "CFO001"},
    {"id": "MGR008",   "name": "Nina Sharma",     "role": "MANAGER",  "department": "Cash Management Team",         "password": "Perfmetric@123", "manager_id": "CFO001"},
    {"id": "EMP001",   "name": "Neo Anderson",    "role": "EMPLOYEE", "department": "Engineering",                  "password": "Perfmetric@123", "manager_id": "MGR001"},
    {"id": "EMP002",   "name": "Trinity Matrix",  "role": "EMPLOYEE", "department": "Engineering",                  "password": "Perfmetric@123", "manager_id": "MGR001"},
    {"id": "EMP003",   "name": "Morpheus Zion",   "role": "EMPLOYEE", "department": "Engineering",                  "password": "Perfmetric@123", "manager_id": "MGR001"},
    {"id": "EMP004",   "name": "Jordan Belfort",  "role": "EMPLOYEE", "department": "Sales",                        "password": "Perfmetric@123", "manager_id": "MGR002"},
    {"id": "EMP005",   "name": "Dwight Schrute",  "role": "EMPLOYEE", "department": "Sales",                        "password": "Perfmetric@123", "manager_id": "MGR002"},
    {"id": "EMP010",   "name": "David Park",      "role": "EMPLOYEE", "department": "Accounts Receivables",         "password": "Perfmetric@123", "manager_id": "MGR003"},
    {"id": "EMP011",   "name": "Layla Hassan",    "role": "EMPLOYEE", "department": "Accounts Receivables",         "password": "Perfmetric@123", "manager_id": "MGR003"},
    {"id": "EMP012",   "name": "Omar Farooq",     "role": "EMPLOYEE", "department": "Accounts Payables",            "password": "Perfmetric@123", "manager_id": "MGR004"},
    {"id": "EMP013",   "name": "Chloe Martin",    "role": "EMPLOYEE", "department": "Accounts Payables",            "password": "Perfmetric@123", "manager_id": "MGR004"},
    {"id": "EMP014",   "name": "Raj Iyer",        "role": "EMPLOYEE", "department": "Fixed Assets",                 "password": "Perfmetric@123", "manager_id": "MGR005"},
    {"id": "EMP015",   "name": "Fatima Al Zaabi", "role": "EMPLOYEE", "department": "Fixed Assets",                 "password": "Perfmetric@123", "manager_id": "MGR005"},
    {"id": "EMP016",   "name": "James Khoury",    "role": "EMPLOYEE", "department": "Treasury and Trade Finance",   "password": "Perfmetric@123", "manager_id": "MGR006"},
    {"id": "EMP017",   "name": "Amira Said",      "role": "EMPLOYEE", "department": "Treasury and Trade Finance",   "password": "Perfmetric@123", "manager_id": "MGR006"},
    {"id": "EMP018",   "name": "Tom Bradley",     "role": "EMPLOYEE", "department": "MIS Report and Internal Audit","password": "Perfmetric@123", "manager_id": "MGR007"},
    {"id": "EMP019",   "name": "Sara Mehta",      "role": "EMPLOYEE", "department": "MIS Report and Internal Audit","password": "Perfmetric@123", "manager_id": "MGR007"},
    {"id": "EMP020",   "name": "Kevin Long",      "role": "EMPLOYEE", "department": "Cash Management Team",         "password": "Perfmetric@123", "manager_id": "MGR008"},
    {"id": "EMP021",   "name": "Hana Yamamoto",   "role": "EMPLOYEE", "department": "Cash Management Team",         "password": "Perfmetric@123", "manager_id": "MGR008"},
]
